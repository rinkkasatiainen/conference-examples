...
This repository contains **legacy code exercises**. Each exercise starts from code that is hard to test and refactor. 
The goal is to learn to experience the legacy code dilemma:
